...
disp_los = np.loadtxt(lasdamas_dir+'cmass_dr10_north_ir4'+str(n+1000)[1:4]+'.v5.1.wght.disp_los.dat')
...
fig1.text(0.5,0.96, 'PTHalo v5.1 ir4'+str(n+1000)[1:4]+' North', ha='center', va='center', fontsize=20)
py.show()
