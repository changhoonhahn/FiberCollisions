pro get_mock_fibcoll_dlos,n
    mock_dir     = '/mount/riachuelo1/hahn/data/manera_mock/v11p0/'
...
;Galaxies with up-weighted w_cp
    ...
    datadir = '/mount/riachuelo1/hahn/data/manera_mock/v11p0/fibcoll/'
    openw, lun, datadir+'cmass_dr11_north_ir4'+strmid(strtrim(string(n+1000),1),1)+'.v11.0.wghtv.'$
