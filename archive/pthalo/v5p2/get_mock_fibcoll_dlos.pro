pro get_mock_fibcoll_dlos,n
    mock_dir     = '/mount/chichipio2/hahn/data/manera_mock/v5p2/'
    mock_file    = 'cmass_dr10_north_ir4'+strmid(strtrim(string(n+1000),1),1)+'.v5.2.wghtv.txt'
    print, mock_file
...
;Galaxies with up-weighted w_cp
    ...
    openw, lun, datadir+'cmass_dr10_north_ir4'+strmid(strtrim(string(n+1000),1),1)+'.v5.2.wghtv.'$
