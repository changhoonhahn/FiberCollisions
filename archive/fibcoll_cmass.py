...
popt, pcov = curve_fit(expon, mpc_bin[0:300], hist_disp_los[0][0:300])
print popt
...
ax1.plot(mpc_bin, expon(mpc_bin, popt[0]), 'r', linewidth=3, label=r'Exponential distribution with $\sigma=$'+str(popt))
ax1.set_xlim([0,50])
...
for d in [20, 30, 40]:
    ...
    ax1.annotate(caption, (float(d),50), xycoords='data', xytext=(float(d), 300), textcoords='data',
