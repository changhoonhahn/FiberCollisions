...
def plot_pk_fibcol_comp(catalog_name, n_mock, corr_methods, quad=False, type='ratio', **kwargs): 
...
if __name__=="__main__":
    ...
    #plot_pk_fibcol_comp('lasdamasgeo', 39, ldg_corr_methods, 
