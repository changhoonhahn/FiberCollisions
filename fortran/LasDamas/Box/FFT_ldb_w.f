c FFT code for LasDamasBox Mock Catalog. 
c code tailored from FFTil4_aniso.f. No random catalog, no FKP weighting!
c Inputs: Lx, Ly, Lz, Parameter File, Mock Galaxy file, FFT output file
c Mock Galaxy file input: x,y,z,weight (for current purposes weight = closepair weight) 
