c FFT code for LasDamasGeo Mock Catalogs using FKP weighting AND systematic weights
c Ngrid=360
c I values computed from random catalog 
c code inputs: Lbox, galaxy/random flag, P0, galaxy/random file, FFT output file
c galaxy file inputs: ra, dec, z*speedoflight
