c FFT code for LasDamasGeo using FKP weighting but NO systematic weights
c I values are computed using Floran Beutler et al. 2013 
...
c random catalog input: ra,dec,z*cspeed
      ...
      real wfkp,wc,wsystem
      real*8 gI10,gI12,gI22,gI13,gI23,gI33
      real*8 rI10,rI12,rI22,rI13,rI23,rI33
...
c      complex dcg(Ngrid,Ngrid,Ngrid),dcr(Ngrid,Ngrid,Ngrid)
 ...
 13      continue
         ...
         do i=1,Ng
            ...
            wc=wg(i)
            wsystem=1.d0
            wfkp=1.d0/(1.d0+(nb*P0)/wsystem)
            gI10=gI10+1.d0
            gI12=gI12+dble(wc*wsystem*wfkp**2)
            gI22=gI22+dble(nb*wc*wfkp**2)
            gI13=gI13+dble(wfkp**3)
            gI23=gI23+dble(nb*wfkp**3 )
            gI33=gI33+dble(nb**2*wfkp**3)
         enddo
 ...
 15      continue
         ...
         do i=1,Nr
            ...
            wc=wr(i)
            wsystem=1.d0
            wfkp=1.d0/(1.d0+nb*P0) 
            rI10=rI10+1.d0
            rI12=rI12+dble(wc*wsystem*wfkp**2)
            rI22=rI22+dble(nb*wc*wfkp**2)
            rI13=rI13+dble(wfkp**3)
            rI23=rI23+dble(nb*wfkp**3 )
            rI33=rI33+dble(nb**2*wfkp**3)
         enddo
         ...
         write(6)real(rI10),real(rI12),real(rI22),real(rI13),real(rI23),
     &   real(rI33)
         write(6)P0,Nr,wsysr
         close(6)
      endif
