c FFT code for LasDamasGeo Mock Catalogs using FKP weighting 
c Inputs: Lbox, galaxy/random flag, P0, galaxy/random file, FFT output file
c Ngrid=360
c galaxy file input format: ra, dec, z*speedoflight
c I11,I12,I22, etc computed using random catalog. Later scaled in powerspectrum code by alpha 
      ...
      real*8 I10,I12,I22,I13,I23,I33,wsysr
 ...
 15      continue
         ...
         write(*,*) 'Nr=',Nr,'Nran=',Nran,'Nr,sys=',wsysr 
