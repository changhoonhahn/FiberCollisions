c PowerSpectrum Code for LasDamasGeo 
c alpha = N_(gal,sys)/N_(random)
c I values comptued from random catalog and then scaled by alpha
      implicit none 
...
c      complex dcg(Ngrid/2+1,Ngrid,Ngrid),dcr(Ngrid/2+1,Ngrid,Ngrid)
      ...
      real akfun,I10,I12,I22,I13,I23,I33,P0,alpha,P0m,Ngsys,Nrsys
      ...
      WRITE(*,*) "Ng=",Ng,"Ng,sys=",Ngsys
      WRITE(*,*) "Nr=",Nr,"Nr,sys=",Nrsys
      alpha=Ngsys/Nrsys !now scale random integrals by alpha
      write(*,*) "alpha=",alpha
      I10=I10*alpha
      I12=I12*alpha
      I22=I22*alpha
