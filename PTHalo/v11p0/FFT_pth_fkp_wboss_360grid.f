...
c weighting scheme only takes into account veto mask and wboss (which is the sector completeness)
...
!         write(*,*)'Random Survey File'
         ...
         do i=1,Nmax
            ...
            dec=dec*(pi/180.)
            rad=chi(az)
            IF (rwb.gt.0. .and. rveto.gt.0.) THEN
                wr(i)=rwb
            ELSE
                wr(i)=0.0
            ENDIF
